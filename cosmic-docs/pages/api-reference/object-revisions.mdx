...
<div label="REST">
```bash
GET $BASE_URL/buckets/${YOUR_BUCKET_SLUG}/objects/${object_id}/revisions?read_key=${YOUR_BUCKET_READ_KEY}
```
...
```bash
GET $BASE_URL/buckets/${YOUR_BUCKET_SLUG}/objects/${object_id}/revisions/${revision_id}?read_key=${YOUR_BUCKET_READ_KEY}
```
...
<div label="REST">
```bash
POST $BASE_URL/buckets/${YOUR_BUCKET_SLUG}/objects/${object_id}/revisions
```
**Header**

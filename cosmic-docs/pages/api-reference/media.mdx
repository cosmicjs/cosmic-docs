...
<div label="REST">
```bash
GET https://api.cosmicjs.com/v2/buckets/${YOUR_BUCKET_SLUG}/media
```
...
<div label="REST">
```bash
GET https://api.cosmicjs.com/v2/buckets/${YOUR_BUCKET_SLUG}/media/${media_id}
```
...
<div label="REST">
```bash
DELETE https://api.cosmicjs.com/v2/buckets/${YOUR_BUCKET_SLUG}/media/${media_id}?trigger_webhook=true
```
**Header**

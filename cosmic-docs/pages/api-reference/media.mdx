...
<div label="REST">
```bash
GET $BASE_URL/buckets/${YOUR_BUCKET_SLUG}/media
```
...
<div label="REST">
```bash
GET $BASE_URL/buckets/${YOUR_BUCKET_SLUG}/media/${media_id}
```
...
```bash
PATCH $BASE_URL/buckets/${YOUR_BUCKET_SLUG}/media/${media_id}
```
...
<div label="REST">
```bash
DELETE $BASE_URL/buckets/${YOUR_BUCKET_SLUG}/media/${media_id}?trigger_webhook=true
```
**Header**

...
<div label="REST">
```bash
GET https://api.cosmicjs.com/v2/buckets/${YOUR_BUCKET_SLUG}/users
```
...
<div label="REST">
```bash
GET https://api.cosmicjs.com/v2/buckets/${YOUR_BUCKET_SLUG}/users/${user_id}
```
...
<div label="REST">
```bash
POST https://api.cosmicjs.com/v2/buckets/${YOUR_BUCKET_SLUG}/users
```
**Example Body (JSON)**
...
```bash
PATCH https://api.cosmicjs.com/v2/buckets/${YOUR_BUCKET_SLUG}/users/${user_id}
```
...
```bash
DELETE https://api.cosmicjs.com/v2/buckets/${YOUR_BUCKET_SLUG}/users/${user_id}
```

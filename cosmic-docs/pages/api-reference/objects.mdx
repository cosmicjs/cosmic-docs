...
**Endpoint**
```bash
GET $BASE_URL/buckets/${YOUR_BUCKET_SLUG}/objects?read_key=${YOUR_BUCKET_READ_KEY}&query=${query}&limit=1
```
...
**Endpoint**
```bash
GET $BASE_URL/buckets/${YOUR_BUCKET_SLUG}/objects?read_key=${YOUR_BUCKET_READ_KEY}&query=${query}&props=${props}&limit=1
```
...
<Tabs>
  <div label="REST">
```bash
GET $BASE_URL/buckets/${YOUR_BUCKET_SLUG}/objects/${object_id}?read_key=${YOUR_BUCKET_READ_KEY}
```
...
```bash
GET $BASE_URL/buckets/${YOUR_BUCKET_SLUG}/objects/${object_id}?read_key=${YOUR_BUCKET_READ_KEY}&props=${props}
```
...
```bash
GET $BASE_URL/buckets/${YOUR_BUCKET_SLUG}/objects/?read_key=${YOUR_BUCKET_READ_KEY}&query={"slug":"object-slug"}&props=${props}
```
...
<div label="REST">
```bash
POST $BASE_URL/buckets/${YOUR_BUCKET_SLUG}/objects
```
**Header**
...
<div label="REST">
```bash
PATCH $BASE_URL/buckets/${YOUR_BUCKET_SLUG}/objects/${object_id}
```
**Header**
...
<div label="REST">
```bash
DELETE $BASE_URL/buckets/${YOUR_BUCKET_SLUG}/objects/${object_id}?trigger_webhook=true
```
**Header**
...
**Endpoint**
```bash
GET $BASE_URL/buckets/${YOUR_BUCKET_SLUG}/merge-requests/${merge_request_id}/objects?query=${query}&props=title,slug
```
...
```bash
GET $BASE_URL/buckets/${YOUR_BUCKET_SLUG}/objects/${object_id}/metafields?read_key=${YOUR_BUCKET_READ_KEY}
```
...
```bash
GET $BASE_URL/buckets/${YOUR_BUCKET_SLUG}/objects/${object_id}/metafields/${metafield_key}?read_key=${YOUR_BUCKET_READ_KEY}
```
...
```bash
POST $BASE_URL/buckets/${YOUR_BUCKET_SLUG}/objects/${object_id}/metafields
```
...
```bash
PATCH $BASE_URL/buckets/${YOUR_BUCKET_SLUG}/objects/${object_id}/metafields/${metafield_key}
```
...
```bash
DELETE $BASE_URL/buckets/${YOUR_BUCKET_SLUG}/objects/${object_id}/metafields/${metafield_key}
```

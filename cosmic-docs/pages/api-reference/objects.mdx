...
The following endpoints allow you to get, add, edit and delete Objects in your Bucket. See [API Introduction](/api-reference/introduction) for getting started information.
...
**Endpoint**
```bash
GET https://api.cosmicjs.com/v2/buckets/${YOUR_BUCKET_SLUG}/objects?read_key=${YOUR_BUCKET_READ_KEY}&query=${query}&limit=1
```
...
**Endpoint**
```bash
GET https://api.cosmicjs.com/v2/buckets/${YOUR_BUCKET_SLUG}/objects?read_key=${YOUR_BUCKET_READ_KEY}&query=${query}&props=${props}&limit=1
```
...
<Tabs>
  <div label="REST">
```bash
GET https://api.cosmicjs.com/v2/buckets/${YOUR_BUCKET_SLUG}/objects/${object_id}?read_key=${YOUR_BUCKET_READ_KEY}
```
...
```bash
GET https://api.cosmicjs.com/v2/buckets/${YOUR_BUCKET_SLUG}/objects/${object_id}?read_key=${YOUR_BUCKET_READ_KEY}&props=${props}
```
...
Note: this method uses the Get Objects endpoint using [queries](/api-reference/queries) and returns an array. This is because, with localization, you can have multiple Objects that use the same slug, but have different locales.
...
```bash
GET https://api.cosmicjs.com/v2/buckets/${YOUR_BUCKET_SLUG}/objects/?read_key=${YOUR_BUCKET_READ_KEY}&query={"slug":"object-slug"}&props=${props}
```
...
| metafields             |          | Array of Objects | Add Metafields to your Object. See [Metafields Model](/api-reference/metafields).   |
...
<div label="REST">
```bash
POST https://api.cosmicjs.com/v2/buckets/${YOUR_BUCKET_SLUG}/objects
```
**Header**
...
<div label="REST">
```bash
PATCH https://api.cosmicjs.com/v2/buckets/${YOUR_BUCKET_SLUG}/objects/${object_id}
```
**Header**
...
<div label="REST">
```bash
DELETE https://api.cosmicjs.com/v2/buckets/${YOUR_BUCKET_SLUG}/objects/${object_id}?trigger_webhook=true
```
**Header**
...
**Endpoint**
```bash
GET https://api.cosmicjs.com/v2/buckets/${YOUR_BUCKET_SLUG}/merge-requests/${merge_request_id}/objects?query=${query}&props=title,slug
```
...
```bash
GET https://api.cosmicjs.com/v2/buckets/${YOUR_BUCKET_SLUG}/objects/${object_id}/metafields?read_key=${YOUR_BUCKET_READ_KEY}
```
...
```bash
GET https://api.cosmicjs.com/v2/buckets/${YOUR_BUCKET_SLUG}/objects/${object_id}/metafields/${metafield_key}?read_key=${YOUR_BUCKET_READ_KEY}
```
...
```bash
POST https://api.cosmicjs.com/v2/buckets/${YOUR_BUCKET_SLUG}/objects/${object_id}/metafields
```
...
```bash
PATCH https://api.cosmicjs.com/v2/buckets/${YOUR_BUCKET_SLUG}/objects/${object_id}/metafields/${metafield_key}
```
...
```bash
DELETE https://api.cosmicjs.com/v2/buckets/${YOUR_BUCKET_SLUG}/objects/${object_id}/metafields/${metafield_key}
```

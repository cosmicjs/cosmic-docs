...
| depth           |          | Number |           | The depth of Object references using Object Relationship Metafields. Circular reference is prohibited.                                                                                                                  |
...
<Callout emoji="💡">
  **Quick Tip**
  <br />
  Use `depth` to limit the Object Metafield reference data returned in the
  metadata property.
</Callout>
...
curl https://api.cosmicjs.com/v2/buckets/${YOUR_BUCKET_SLUG}/objects \
	-d read_key=${YOUR_BUCKET_READ_KEY} \
	--data-urlencode query='{"type":"posts"}' \
 	-d props="title,content,metadata" \
	-d depth=1 \
	-d limit=1 \
	-G
```
...
**Example Response with Depth**

Depth set to `1` will return the nested data for the connected Objects on the first level and nothing more. In this case, the author data is returned, but not the favorite foods Objects.

```json
{
  "objects": [
    {
      "title": "Using depth to limit the payload references",
      "content": "<p>Use depth to limit the Object relationshipt references</p>",
      "metadata": {
        "author": {
          "id": "637424d79e48068a8e004c3d",
          "slug": "tony",
          "title": "Tony",
          "content": "",
          "bucket": "63741869f5085b000889937e",
          "created_at": "2022-11-15T23:19:34.716Z",
          "modified_at": "2022-11-16T18:20:41.202Z",
          "status": "published",
          "thumbnail": "https://imgix.cosmicjs.com/bde84da0-653a-11ed-a307-d9b518ba824e-tux-cropped.jpg",
          "published_at": "2022-11-16T18:20:41.202Z",
          "modified_by": "637413416bd19f00082936eb",
          "created_by": "637413416bd19f00082936eb",
          "publish_at": null,
          "created": "2022-11-15T23:19:34.716Z",
          "type": "people",
          "metadata": {
            "tagline": "LFG",
            "favorite_foods": [
              "637529e89b7c3a0008186af3",
              "637529e89b7c3a0008186af4"
            ]
          }
        }
      }
...
curl https://api.cosmicjs.com/v2/buckets/${YOUR_BUCKET_SLUG}/objects \
	-d read_key=${YOUR_BUCKET_READ_KEY} \
	--data-urlencode query='{"type":"posts","slug":"object-slug"}' \
...
```
  ...
  <a href="https://cosmic-graphql-playground.netlify.app/?endpoint=https%3A%2F%2Fgraphql.cosmicjs.com%2Fv3&query=%20query%20%28%24bucket_slug%3A%20String%21%2C%20%24read_key%3A%20String%29%20%7B%0A%20%20getObjects%28%0A%20%20%20%20bucket_slug%3A%20%24bucket_slug%0A%20%20%20%20read_key%3A%20%24read_key%0A%20%20%20%20input%3A%20%7B%0A%20%20%20%20%20%20query%3A%20%7B%0A%20%20%20%20%20%20%20%20slug%3A%20%22object-slug%22%0A%20%20%20%20%20%20%7D%0A%20%20%20%20%20%20props%3A%20%22title%22%0A%20%20%20%20%7D%0A%20%20%29%20%7B%0A%20%20%20%20%20%20objects%20%7B%0A%20%20%20%20%20%20%20%20title%0A%20%20%20%20%20%20%7D%0A%20%20%7D%0A%7D">
    Full screen
  </a>
  <iframe
...
**Example Request**
```bash
cosmic get-objects --query {"type":"posts","slug":"object-slug"} --props "title,content,metadata.parent.title,metadata.parent.metadata.category.metadata.description"
```
...
| props           |          | String |           | Declare which properties to return in comma-separated string. Remove to see full Object and get a list of all available properties. Can include nested metadata. Example: `id,title,metadata.author.metadata.image.url` |
| status          |          |  Enum  | published | Set to `any` for latest draft or published Object                                                                                                                                                                       |
| depth           |          | Number |           | The depth of Object references using Object Relationship Metafields. Limit is at first reference of infinite recursion.                                                                                                 |
| pretty          |          |  Enum  | false     | Set to `true` to make the response more reader-friendly                                                                                                                                                                 |
| show_metafields |          |  Enum  | false     | Set to `true` to show metafields                                                                                                                                                                                        |
| use_cache       |          |  Enum  | true      | Set to `false` for real-time updates. Increases latency of endpoint.                                                                                                                                                    |
...
```
  ...
  <a href="https://cosmic-graphql-playground.netlify.app/?endpoint=https%3A%2F%2Fgraphql.cosmicjs.com%2Fv3&query=%20query%20%28%24bucket_slug%3A%20String%21%2C%20%24read_key%3A%20String%2C%20%24object_id%3A%20ID%21%29%20%7B%0A%20%20getObject%28%0A%20%20%20%20bucket_slug%3A%20%24bucket_slug%0A%20%20%20%20read_key%3A%20%24read_key%0A%20%20%20%20object_id%3A%20%24object_id%0A%20%20%29%20%7B%0A%20%20%20%20%20%20title%0A%20%20%7D%0A%7D">
    Full screen
  </a>
  <iframe
    src="https://cosmic-graphql-playground.netlify.app/?endpoint=https%3A%2F%2Fgraphql.cosmicjs.com%2Fv3&query=%20query%20%28%24bucket_slug%3A%20String%21%2C%20%24read_key%3A%20String%2C%20%24object_id%3A%20ID%21%29%20%7B%0A%20%20getObject%28%0A%20%20%20%20bucket_slug%3A%20%24bucket_slug%0A%20%20%20%20read_key%3A%20%24read_key%0A%20%20%20%20object_id%3A%20%24object_id%0A%20%20%29%20%7B%0A%20%20%20%20%20%20title%0A%20%20%7D%0A%7D"
...
```
  ...
  <a href="https://cosmic-graphql-playground.netlify.app/?endpoint=https%3A%2F%2Fgraphql.cosmicjs.com%2Fv3&query=%20query%20%28%24bucket_slug%3A%20String%21%2C%20%24read_key%3A%20String%2C%20%24object_id%3A%20ID%21%29%20%7B%0A%20%20getObject%28%0A%20%20%20%20bucket_slug%3A%20%24bucket_slug%0A%20%20%20%20read_key%3A%20%24read_key%0A%20%20%20%20object_id%3A%20%24object_id%0A%20%20%20%20input%3A%20%7B%0A%20%20%20%20%20%20props%3A%20%22title%22%0A%20%20%20%20%7D%0A%20%20%29%20%7B%0A%20%20%20%20%20%20title%0A%20%20%7D%0A%7D">
    Full screen
  </a>
  <iframe
    src="https://cosmic-graphql-playground.netlify.app/?endpoint=https%3A%2F%2Fgraphql.cosmicjs.com%2Fv3&query=%20query%20%28%24bucket_slug%3A%20String%21%2C%20%24read_key%3A%20String%2C%20%24object_id%3A%20ID%21%29%20%7B%0A%20%20getObject%28%0A%20%20%20%20bucket_slug%3A%20%24bucket_slug%0A%20%20%20%20read_key%3A%20%24read_key%0A%20%20%20%20object_id%3A%20%24object_id%0A%20%20%20%20input%3A%20%7B%0A%20%20%20%20%20%20props%3A%20%22title%22%0A%20%20%20%20%7D%0A%20%20%29%20%7B%0A%20%20%20%20%20%20title%0A%20%20%7D%0A%7D"
...
const data = await bucket.objects.insertOne(params);
```
...
<Tabs>
	<div label="Node.js">
```javascript
bucket.objects.updateOne(query, updates)
```
...
const data = await bucket.objects.updateOne(
  {
    id: "5ff75368c2dfa81a91695cec",
  },
  {
...
const data = await bucket.objects.deleteOne({
  id: "5ff75368c2dfa81a91695cec",
});
```
...
<a href="https://cosmic-graphql-playground.netlify.app/?endpoint=https%3A%2F%2Fgraphql.cosmicjs.com%2Fv3&query=%20query%20%28%24bucket_slug%3A%20String%21%2C%20%24read_key%3A%20String%2C%20%24merge_request_id%3A%20ID%21%2C%20%24query%3A%20String%29%20%7B%0A%20%20getMergeRequestObjects%28%0A%20%20%20%20bucket_slug%3A%20%24bucket_slug%0A%20%20%20%20read_key%3A%20%24read_key%0A%20%20%20%20merge_request_id%3A%20%24merge_request_id%0A%20%20%20%20input%3A%20%7B%0A%20%20%20%20%20%20query%3A%20%24query%0A%20%20%20%20%7D%0A%20%20%29%20%7B%0A%20%20%20%20%20objects%20%7B%0A%20%20%20%20%20%20id%0A%20%20%20%20%20%20title%0A%20%20%20%20%20%20slug%0A%20%20%20%20%7D%0A%20%20%20%20total%0A%20%20%7D%0A%7D">Full screen</a>
<iframe src="https://cosmic-graphql-playground.netlify.app/?endpoint=https%3A%2F%2Fgraphql.cosmicjs.com%2Fv3&query=%20query%20%28%24bucket_slug%3A%20String%21%2C%20%24read_key%3A%20String%2C%20%24merge_request_id%3A%20ID%21%2C%20%24query%3A%20String%29%20%7B%0A%20%20getMergeRequestObjects%28%0A%20%20%20%20bucket_slug%3A%20%24bucket_slug%0A%20%20%20%20read_key%3A%20%24read_key%0A%20%20%20%20merge_request_id%3A%20%24merge_request_id%0A%20%20%20%20input%3A%20%7B%0A%20%20%20%20%20%20query%3A%20%24query%0A%20%20%20%20%7D%0A%20%20%29%20%7B%0A%20%20%20%20%20objects%20%7B%0A%20%20%20%20%20%20id%0A%20%20%20%20%20%20title%0A%20%20%20%20%20%20slug%0A%20%20%20%20%7D%0A%20%20%20%20total%0A%20%20%7D%0A%7D" frameBorder="0" style={{ width: '100%', height: '470px'}}></iframe>
</div>

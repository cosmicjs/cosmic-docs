...
Creates a new Object to your Bucket.
...
Edits an existing Object in your Bucket.

**Definition**

```bash
PATCH https://api.cosmicjs.com/v2/buckets/${YOUR_BUCKET_SLUG}/objects/:id
```
...
Deletes an Object from your Bucket. This cannot be undone.

**Definition**

```bash
DELETE https://api.cosmicjs.com/v2/buckets/${YOUR_BUCKET_SLUG}/objects/:id
```
...
```bash
GET https://api.cosmicjs.com/v2/buckets/${YOUR_BUCKET_SLUG}/merge-requests/:id/objects
```
...
Returns a single Metafield from your Object.
...
Creates a new Metafield on an Object. See [Metafields Model](/api-reference/metafields) for available parameters.
...
```bash
PATCH /v2/buckets/${YOUR_BUCKET_SLUG}/objects/:id/metafields/${metafield_key}
```
...
```bash
DELETE https://api.cosmicjs.com/v2/buckets/${YOUR_BUCKET_SLUG}/objects/:id/metafields/:key
```
...
```json
{
  "message": "metafield with key: '${metafield_key}' deleted successfully from object with id:':id"
}
```

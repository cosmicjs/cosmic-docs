...
<div label="REST">
```bash
GET $BASE_URL/buckets/${YOUR_BUCKET_SLUG}/object-types
```
...
```bash
GET $BASE_URL/buckets/${YOUR_BUCKET_SLUG}/object-types/${slug}
```
...
<div label="REST">
```bash
POST $BASE_URL/buckets/${YOUR_BUCKET_SLUG}/object-types
```
**Header**
...
<div label="REST">
```bash
PATCH $BASE_URL/buckets/${YOUR_BUCKET_SLUG}/object-types/${type_slug}
```
**Header**
...
<div label="REST">
```bash
DELETE $BASE_URL/buckets/${YOUR_BUCKET_SLUG}/object-types/${type_slug}
```
**Header**

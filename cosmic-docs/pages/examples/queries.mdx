...
<Tabs>
  <div label="REST">
    ```bash
    GET $BASE_URL/buckets/${YOUR_BUCKET_SLUG}/objects?read_key=${YOUR_BUCKET_READ_KEY}&query={"$or":[{"metadata.category":"Electronics"},{"metadata.charge_taxes":true}]}
    ```
  </div>
  <div label="Node.js">
    ```javascript
  ...
  <div label="CLI">
    ```bash
    cosmic get-objects --query '{"$or":[{"metadata.category":"Electronics"},{"metadata.charge_taxes":true}]}'
    ```
  </div>
</Tabs>
...
<Tabs>
  <div label="REST">
    ```bash
    GET $BASE_URL/buckets/${YOUR_BUCKET_SLUG}/objects?read_key=${YOUR_BUCKET_READ_KEY}&query={"$and":[{"metadata.quantity":{"$lt":50}},{"metadata.price":{"$lt":79.99}}]}
    ```
  </div>
  <div label="Node.js">
    ```javascript
  ...
  <div label="CLI">
    ```bash
    cosmic get-objects --query '{"$and":[{"metadata.quantity":{"$lt":50}},{"metadata.price":{"$lt":79.99}}]}'
    ```
  </div>
</Tabs>

...
To show off some of these advanced queries, we're going to show how they can be used in a real Cosmic app. We'll use the [non-profit Next.js template](https://github.com/cosmicjs/nextjs-non-profit-website) as our starting point and fetch the data with a number of different queries.

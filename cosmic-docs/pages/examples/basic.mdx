...
1. Run the code examples as is or
2. [Install the template](https://www.cosmicjs.com/apps/simple-react-blog) into your account then switch `YOUR_BUCKET_SLUG` and `YOUR_BUCKET_READ_KEY` to your Bucket access keys. You can find these values located in <i>Your Bucket > Settings > API Access</i> after logging in to your <a href="https://app.cosmicjs.com">Cosmic dashboard</a>.

...
We'll be using the [Simple React Blog](https://www.cosmicjs.com/apps/simple-react-blog) app template for the following basic query examples. You can install the demo content into your account then in the following code examples, switch the `BUCKET_SLUG` and `BUCKET_READ_KEY` to your Bucket access keys. You can find these values located in <i>Your Bucket > Settings > API Access</i> after logging in to your <a href="https://app.cosmicjs.com">Cosmic dashboard</a>.

...
| query           |          |  JSON  |           | A JSON string to perform advanced queries to filter out objects. Please see [Examples](/api-reference/queries#example-queries) for more detail.                                                              |
...
**Example Response with Props (status: `200 OK`)**
...
| metafields             |          | Array of Object | Add Metafields to your Object. See [Metafields Model](/api-reference/getting-started/metafields). |

...
**Example Request**
```bash
cosmic get-objects --limit 10 --type=posts
```
</div>
</Tabs>
...
**Example Request**
```bash
cosmic get-objects --limit 10 --type=posts --props=title,content,metadata.parent.title,metadata.parent.metadata.category.metadata.description
```

...
- The Select Dropdown Metafield API response now includes both `key` and `value`.
...
- More strict user input requirements. No additional fields are possible in the body for `POST` and `PATCH` requests.

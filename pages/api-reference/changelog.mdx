...
- Objects are now only able to be searched and filtered using the `query` param (Advanced Queries in v1). See [Queries and Logic](/api-reference/queries) for examples.

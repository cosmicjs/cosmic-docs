...
- Queries is now a first-class method for searching and filtering Objects (Advanced Queries in v1). See [Queries and Logic](/api-reference/queries) for examples.

...
Cosmic provides the ability to add localization to your Objects. To add localization:

1. [Log in to your Cosmic account](https://app.cosmicjs.com/login) and go to any Bucket
2. Go to any <i>Object Type > Settings</i>
3. Scroll down to the Localization section
4. Select from hundreds of locales below and save Object Type
5. Go to any new or existing Object in this type, you will see the Locale select option

## API Usage

See [localization example in Queries section](http://localhost:5000/api-reference/queries#localization) for an example query.

## Avalilable Locales

The following are the available locales that can be used in Cosmic API for localization.

...
<div label="REST">
```bash
POST https://upload.cosmicjs.com/v2/:bucket_slug/media
```
</div>
<div label="Bash">
```bash
curl --form "folder=folder-name" --form "media=@test.png" -H "Authorization: Bearer <write-key>" 'https://upload.cosmicjs.com/v2/:bucket_slug/media'
```
</div>
...
**Example Request**
```bash
cosmic delete-media --id 1234asdf
```
</div>
</Tabs>

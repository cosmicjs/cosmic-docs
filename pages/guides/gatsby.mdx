...
Before adding any code, make sure to follow the [Initial Setup](/guides/initial-setup) at the top of this page to set up your content in Cosmic. Then take the following steps to add Cosmic-powered content to your Gatsby apps:

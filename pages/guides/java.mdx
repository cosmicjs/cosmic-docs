...
Inside the folder `src/main/resources`, add the Cosmic credentials to the `application.properties` file. You can find your Bucket slug and API read key in <i>Your Bucket > Settings > API Access</i> after [logging in](https://app.cosmicjs.com).

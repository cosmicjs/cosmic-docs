...
Reference the [Metafield model](/cosmic-api/getting-started/metafields) to learn more.
...
| value       |          | String | For single Object this is the \id property. For multiple Objects it is comma-separated \_ids. |

...
| locales                | required if localization is true | Array of String | Array of active locales in the Object Type. Check the [available locale codes](/cosmic-api/locales).                                            |
| priority_locale        |                                  |     String      | Default locale code for Objects in Object Type. Check the [available locale codes](/cosmic-api/locales)                                         |

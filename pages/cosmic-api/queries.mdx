...
Queries give you powerful NoSQL database-like functionality for content fetching. Use the query parameter to send a valid JSON (stringified) query on the [Get Objects Endpoint](/cosmic-api/objects#get-objects). See [example requests below](/cosmic-api/advanced-queries/#example-queries).

...
```bash
GET $BASE_URL/buckets/${bucket_slug}/objects/metafields
```
...
Take a look at [Metafield Model](/cosmic-api/getting-started/metafields) for reference to be passed in the body.

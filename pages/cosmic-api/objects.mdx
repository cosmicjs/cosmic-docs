...
| query           |          |  JSON  |           | A JSON string to perform advanced queries to filter out objects. Please see [Examples](/cosmic-api/advanced-queries#example-queries) for more detail.                                                        |

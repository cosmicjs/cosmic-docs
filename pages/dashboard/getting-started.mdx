...
2. Create a new Bucket: Start from scratch or install one of the [Community Apps](https://www.cosmicjs.com/apps) (to see how content is modeled for a specific use case)
...
<i>Merge Requests</i> is a feature that provides Git-like workflows for your content.
It breaks you out of the rigid draft / published process of common CMS systems and
gives your team a more fluid way to do bulk edit reviews, approvals, and sweeping
edits across your Bucket environments. To learn more:
